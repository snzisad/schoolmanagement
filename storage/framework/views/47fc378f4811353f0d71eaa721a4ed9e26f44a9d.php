...
<script src="<?php echo e(asset('content/js/login.js')); ?>"></script>
...
<!--
    ...
    <div class="container">
        <div class="card card-container">
            <img id="profile-img" class="profile-img-card" src="<?php echo e(asset('content/images/logo.png')); ?>" />
            ...
            <?php endif; ?>
            <form id="login_form" method="POST" action="<?php echo e(route('custom.login')); ?>">
